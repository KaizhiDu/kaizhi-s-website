                ...
                <CardDeck>
                    <Card className="project">
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                After I finished the course of react + node by Brad Traversy and Stephen Grider, I decided to combine the advantages of both to develop my own personal webpage, which is the page you are currently browsing.
                            </Card.Text>
                        </Card.Body>
                        <Card.Footer>
                    ...
                    <Card className="project">
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                I followed Brad Traversy's course to complete this code. Brad taught me how to use JWT, Hooks and other knowledge. Helped me a lot
                            </Card.Text>
                        </Card.Body>
                        <Card.Footer>
                            <small className="text-muted">javascript, react, node, express, mongoDB, mongoose</small>
                    ...
                    <Card className="project">
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                I followed this code by Stephen Grider. In addition to basic knowledge of react, redux, and node, Stephen also teaches how to use useful knowledge such as Stript, sendGrid, Oauth, and redux-form. I learned a lot of new things.
                            </Card.Text>
                        </Card.Body>
                        <Card.Footer>
                            <small className="text-muted">javascript, react, node, express, mongoDB, mongoose</small>
                ...
                <CardDeck>
                    <Card className="project">
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                We have a course called IT-510 Software Development. The professor asked us to complete a project. I decided to use the node and MongoDB I just learned with javascript to construct this project.
                            </Card.Text>
                        </Card.Body>
                        <Card.Footer>
                    ...
                    <Card className="project">
                        ...
                        <Card.Body>
                            ...
                            <Card.Text>
                                Since I have a habit of taking notes, I developed a blog that supports markdown format, supports comments and likes
                            </Card.Text>
                        </Card.Body>
                        <Card.Footer>
                    ...
                    <Card className="project">
                        ...
                        <Card.Body>
                            <Card.Title>
                                <a href="https://github.com/KaizhiDu/Bingzheng-Mechanical-Management-System" target="_blank">Bingzheng Machinery Management System</a>
                            </Card.Title>
                            <Card.Text>
                                My father does mechanical product processing. Due to the company's growth and business growth, a management software is needed to manage the company. I bought a general machine management software before, but it is not suitable for company use. So I developed a software based on my father's request.
                            </Card.Text>
                        </Card.Body>
                        <Card.Footer>
